    ...
    public static void main(String[] args) {
        ...
        while (!ganhou) {
            ...
            if (    (jogoDaVelha[0][0] == 'X' && jogoDaVelha[0][1] == 'X' && jogoDaVelha[0][2] == 'X')  ||  // Verificando Linha 0
                    ...
                    (jogoDaVelha[0][0] == 'X' && jogoDaVelha[1][1] == 'X' && jogoDaVelha[2][2] == 'X')  ||  // Verificando Diagonal 1
                    (jogoDaVelha[2][0] == 'X' && jogoDaVelha[1][1] == 'X' && jogoDaVelha[0][2] == 'X')      // Verificando Diagonal 2
            ) {
                ganhou = true;
                System.out.println("Parabéns jogador 1, ganhou!");
                        ...
                        (jogoDaVelha[0][0] == 'O' && jogoDaVelha[1][1] == 'O' && jogoDaVelha[2][2] == 'O')  ||  // Verificando Diagonal 1
                        (jogoDaVelha[2][0] == 'O' && jogoDaVelha[1][1] == 'O' && jogoDaVelha[0][2] == 'O')      // Verificando Diagonal 2
            ) {
                ganhou = true;
