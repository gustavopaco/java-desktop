...
public class CrudAlunosBySecretario {
	...
	public static void main(String[] args) {
		...
		while(validaUser == false) {
			...
			/* Exemplo de polimorfismo, onde a classe Secretario implementa a interface PermitirAcesso */
			PermitirAcesso secretario = new Secretario(login,senha);
			
			if (secretario.autenticar()) { /* SE TRUE USUARIO LOGADO, SE NAO USUARIO OU SENHA INVALIDO*/
				validaUser = true;
