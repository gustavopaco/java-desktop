...
public class CrudAlunosBySecretarioV3 {
	...
	public static void main(String[] args) {
		...
		while(validaUser == false) {
			...
			/* Exemplo de polimorfismo onde uma classe que recebe a interface PermitirAcesso como parâmetro, para autenticar o acesso */
			if (autenticacao.autenticarCursoJava(permitirAcesso)) { /* VOU TRAVAR O CONTRATO PARA AUTORIZAR SOMENTE QUEM REALMENTE TEM O CONTRATO LEGITIMO*/
				validaUser = true;
