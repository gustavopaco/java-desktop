...
public class CrudAlunosBySecretarioV4 {
	...
	public static void main(String[] args) {
		...
		while(validaUser == false) {
			...
			FuncaoAutenticacao autenticacao = new FuncaoAutenticacao(permitirAcesso);

			/* Exemplo de polimorfismo, onde o método autenticarLogin faz a autenticacao do usuário, pois a classe FuncaoAutenticacao recebe a interface PermitirAcesso como parâmetro e a classe Secretario implementa a interface PermitirAcesso */
			if (autenticacao.autenticarLogin()) { /* VOU TRAVAR O CONTRATO PARA AUTORIZAR SOMENTE QUEM REALMENTE TEM O CONTRATO LEGITIMO*/
				validaUser = true;
