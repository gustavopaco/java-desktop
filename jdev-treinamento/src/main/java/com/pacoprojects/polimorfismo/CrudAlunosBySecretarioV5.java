...
public class CrudAlunosBySecretarioV5 {
	...
	public static void main(String[] args) {
		...
		while(validaUser == false) {
			...
			if (new FuncaoAutenticacao(permitirAcesso).autenticarLogin()) { /* VOU TRAVAR O CONTRATO PARA AUTORIZAR SOMENTE QUEM REALMENTE TEM O CONTRATO LEGITIMO*/
				validaUser = true;
