package main.java.com.pacoprojects.aula88.util.gregoriancalendar;
...
public class Boot {
    public static void main(String[] args) {
        ...
        imprimirData(calendar);

        System.out.println("ANO BISSEXTO: " + calendar.isLeapYear(2023));

        GregorianCalendar calendar2 = new GregorianCalendar(1989, 8, 24, 16, 30, 0);
    }

    private static void imprimirData(Calendar calendar) {
